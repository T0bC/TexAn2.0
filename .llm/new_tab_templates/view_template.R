  ...
  sidebar_tabs$tab_layout(
    ...
    tabs = list(
      ...
      sidebar_tabs$create_tab(
        ...
        value = "settings_tab",
        shiny$h6(class = "text-muted mb-3", "Settings"),
        shiny$numericInput(
          inputId = ns("param1"),
          label = "Parameter",
          value = 10,
    ...
    # Uncomment for an action button below the sidebar tabs:
    # action_button = shiny$actionButton(
    #   inputId = ns("run_analysis"),
    #   label = "Run Analysis",
    #   class = "btn-primary btn-sm w-100"
    # ),
    # Uncomment for responsive plot support:
